package main.com.KaPrim.staticData;
...
public class ExceptionMessages {
    ...
    public static final String NON_EXISTING_COURSE = "CourseImpl does not exist.";
    public static final String NON_EXISTING_STUDENT = "StudentImpl does not exist.";
