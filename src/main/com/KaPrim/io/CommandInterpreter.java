...
public class CommandInterpreter {
    ...
    private static final String COMMAND_LOCATION = "src/main/com/KaPrim/io/commands";
    private static final String COMMAND_PACKAGE = "main.com.KaPrim.io.commands.";
